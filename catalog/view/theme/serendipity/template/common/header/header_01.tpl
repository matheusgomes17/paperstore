			...
			<div class="background">
				...
				<div class="pattern">
				     <div class="top-bar">
				          <div class="container">
                          <div class="col-sm-6">
                         <p class="w-txt"> Welcome To Our Website!
                          </p>
                          </div>
                           ...
                           <div class="col-sm-6">
                            <!-- Links -->
				               <ul class="menu">
				               	<li><a href="<?php echo $account; ?>"><i class="fa fa-bank"></i><span><?php echo $text_account; ?></span></a></li>
				               	...
				               	<li><a href="<?php echo $checkout; ?>"><i class="fa fa-shopping-cart"></i><span><?php echo $text_checkout; ?></span></a></li>
				               		<?php if ($logged) { ?>
				               		<li><a href="<?php echo $logout; ?>"><?php echo $text_logout; ?></a></li>
				               		<?php } ?>
                                    <li>
				               <?php echo $currency.$language; ?></li>
				               </ul>
                           </div>
