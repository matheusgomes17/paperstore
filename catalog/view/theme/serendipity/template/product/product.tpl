...
<div itemscope itemtype="http://schema.org/Product">
  ...
  <div class="product-info">
  	<div class="row">
  	     <center><a target="_blank" href="http://gccworld.info/doc/serendipity/"><b><u>Theme Installation Error: Delete Cache or Re-Download and re-upload or check documentation here</u></b></a></center>
			     ...
			     <div id="product">
			      ...
			      <div class="cart">
			        ...
			        <div class="links clearfix">
			        	...
			        	<li><i class="fa fa-toggle-on"></i><a onclick="compare.add('<?php echo $product_id; ?>');"><?php if($theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'add_to_compare_text', $config->get( 'config_language_id' ) ); } else { echo 'Add to compare'; } ?></a></li>
                        </ul>
			        </div>
